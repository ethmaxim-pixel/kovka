 ...
 * Features: Navigation, contact info, social links
 */

const footerLinks = {
  catalog: [
    { href: "/catalog", label: "Каталог товаров" },
    { href: "/catalog?category=balyasiny", label: "Балясины" },
    { href: "/catalog?category=venzelya", label: "Вензеля" },
    ...
    <footer className="bg-card border-t border-border/50">
      <div className="container py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>г. Луганск, ул. Лутугинская</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          {/* Catalog Links */}
          <div>
            <h4 className="text-sm font-semibold text-foreground mb-4 font-[family-name:var(--font-heading)]">
              Каталог
            </h4>
          ...
          <div>
            ...
            {/* Social Links */}
            <div className="mt-6">
              <h4 className="text-sm font-semibold text-foreground mb-3 font-[family-name:var(--font-heading)]">
                Мы в соцсетях
              </h4>
              <div className="flex gap-3">
                <a
                  href="#"
                  className="w-10 h-10 rounded-lg bg-muted/50 flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-all"
                  aria-label="VK"
                >
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © 2024 Ковка в Дворик. Все права защищены.
            </p>
